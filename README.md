...
### Задание 1
```python
#Здесь я немного не понял как нужно получать входные данные и заморочился... В общем выбирайте какую функцию хотите примиъенить (консоль все подскажет), если выбрали флаттен то сколько массивов добавить, и добавляйте сам тест-кейс
